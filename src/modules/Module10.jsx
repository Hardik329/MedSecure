...
const Module10 = ({ title }) => {
  ...
  const responseSteps = [
    {
      step: "Preparation",
      description:
        "Develop policies, communication plans, and assign roles before an incident occurs.",
    },
    {
      step: "Detection & Analysis",
      description:
        "Identify and assess suspicious activity or breaches through monitoring tools.",
    },
    {
      step: "Containment",
      description:
        "Isolate affected systems to prevent spread or further damage.",
    },
    {
      step: "Eradication",
      description:
        "Remove the root cause, such as malware or unauthorized access.",
    },
    {
      step: "Recovery",
      description:
        "Restore systems to normal operation and monitor for signs of reinfection.",
    },
    {
      step: "Post-Incident Review",
      description:
        "Conduct a review to improve future response processes and document findings.",
    },
  ];
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      options: [
        "To notify media quickly",
        "To allow devices to keep running normally",
        "To limit damage and prevent spread of threats",
    ...
    },
    {
      ...
      options: [
        "It involves devices tied to patient safety",
        "It's always handled by software vendors",
        "It doesn't require documentation",
        "It never involves actual security threats",
      ],
      correctIndex: 0,
    },
  ];
  ...
  return (
    <div className="">
      <div className="bg-[#1c2538] h-40 flex items-center justify-center">
        <h1 className="text-4xl font-bold text-white">Module 10: {title}</h1>
      </div>
      <div>
        <ProgressBar />
      </div>
      <div className="p-6 max-w-5xl mx-auto">
        ...
        <Section title="Why Incident Response Matters">
          <p>
            Incident response in healthcare protects not only data but also
            patient well-being. A slow or uncoordinated response can result in
            operational downtime, legal issues, or patient harm.
          </p>
        </Section>
        ...
        <Section title="Medical IoT Specific Challenges">
          <p>
            Many medical devices cannot be easily patched or disconnected.
            Incident response must factor in the clinical impact, device uptime
        ...
        <Section title="Real-World Case Study">
          <HighlightBox>
            ...
            <p>
              A ransomware attack crippled a hospital network, encrypting access
              to imaging and patient tracking systems. Swift containment and
              recovery limited the impact to under 48 hours.
            </p>
          </HighlightBox>
        </Section>
          ...
          terms={[
            {
              term: "Containment",
              definition:
                "A set of actions taken to isolate the threat and stop its spread.",
            },
            {
              term: "Eradication",
              definition:
                "Removing malicious code, accounts, or persistence mechanisms after an attack.",
            },
            {
              term: "Playbook",
              definition:
                "Predefined actions and workflows for incident handling.",
            },
          ]}
        />
